          ...
          <div class="jdlh3">Upload Dokumen </div>
            <form action="proses.php" method="post">
                ...
                <div class="form-group" style="user-select: auto;">
                    ...
                    <select id="inputid" class="form-control" ] aria-required="true" style="user-select: auto; width: 75%; height: 23px; margin-top:15px; margin-bottom: 15px;">
                    ...
                    <option value="8" selected="" style="user-select: auto;">2019</option>
                        ...
                        <div class="col-sm-6  " style="user-select: auto;">
                        <select id="inputid" class="form-control"  aria-required="true" style="user-select: auto; height: 23px; margin-top:15px; margin-bottom: 15px;">
                        <option value="" style="user-select: auto;">Select...</option>
                ...
                <a href="login"><button>Upload</a> 
                </div>
            </form>
        </div>
    </body>
</html><?php /**PATH D:\Proyek-04\kelompok-03\resources\views/upload.blade.php ENDPATH**/ ?>